...
2. Search "Hiring for React Developers" on linkedin
    ...
    4. Repeat this process every night so that by morning at 10:30am, 40-50 (try to find 80 daily) emails are sent to the hiring managers automatically. It can save upto 40 minutes daily which can be utilised in other productive work.
